...
export default function Works() {
  ...
  const ctaStyle = isDesktop ? { fontSize: fluid(17, 24), lineHeight: fluid(24, 34) } : {}
  const contentStyle = isDesktop ? { paddingTop: fluid(216, 300), paddingBottom: fluid(72, 100), gap: fluid(43, 60) } : {}
  ...
  return (
    <section ref={sectionRef} className="relative bg-white overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center gap-8 pt-[120px] sm:pt-[180px] pb-[50px]" style={contentStyle}>

        {/* Title */}
        <div ref={titleRef} className="px-5 md:px-[80px] w-full flex flex-col items-center">
          <p className="text-black text-[28px] sm:text-[36px] font-light font-['Geist'] tracking-[-1.2px] md:tracking-[-2.4px] text-center" style={titleStyle}>
            Designing products
          </p>
          <p className="text-black text-[28px] sm:text-[36px] font-light font-['Geist'] tracking-[-1.2px] md:tracking-[-2.4px] text-center" style={titleStyle}>
          ...
          >
            {carouselSlides.map(({ src, offset, href }, i) => (
              <a
                ...
                style={{
                  width: isDesktop ? fluid(266, 370) : '280px',
                  aspectRatio: '500 / 400',
                  marginTop: `${offset * (isDesktop ? 1 : 0.5)}px`,
                }}
              >
                <img
                  src={src}
        ...
        <div ref={ctaRef} className="flex flex-col items-center gap-[20px] md:gap-[30px] px-5">
          <p className="text-center text-[18px] font-light font-['Geist'] leading-[26px] tracking-[-0.48px] w-full max-w-[604px]" style={ctaStyle}>
